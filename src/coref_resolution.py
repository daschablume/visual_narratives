...
def simple_coref_resolution(text: str) -> str:
    '''
    Resolve pronouns in text by replacing them with the first subject found.
    
    Args:
        text: Input text string to process.
        
    Returns:
        Text with capitalized pronouns (They/It/She/He) replaced by the first subject.
    '''
    spans = []
    doc = NLP(text)
...
def resolve_in_batches(texts: list[str]) -> list[str]:
    """
    Batch process multiple texts for pronoun resolution using spaCy's pipe.
    
    Args:
        texts: List of text strings to process.
        
    Returns:
        List of texts with pronouns replaced by the first subject in each text.
    """
